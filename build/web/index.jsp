...
<body>
    ...
    <div class="container">
        ...
        <div class="top-header">
            <div class="logo">
                <a href="index"><img  src="images/isc3.png" style="border-radius: 10px; width: 200px; height: 100px; margin-left: 15px" title="barndlogo" /></a>
            </div>
            <div class="top-header-info" style="margin-top: 30px">
